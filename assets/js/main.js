...
if (selectedTheme) {
  ...
  // Default to dark theme if no selection exists
  document.body.classList.add(darkTheme);
  themeButton.classList.add(iconTheme);

  // Save the default dark theme in sessionStorage
  sessionStorage.setItem('selected-theme', 'dark');
  sessionStorage.setItem('selected-icon', 'uil-sun');
}
...
themeButton.addEventListener('click', () => {
  ...
  // Save the current theme and icon in sessionStorage
